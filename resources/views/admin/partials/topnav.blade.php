...
<nav class="navbar-wrapper bg--dark">
	...
	<div class="navbar__right">
		<ul class="navbar__action-list">
			...
			<li class="dropdown">
				<button class="primary--layer" data-bs-toggle="dropdown" data-display="static" type="button" aria-haspopup="true"
					aria-expanded="false">
				...
				<div class="dropdown-menu dropdown-menu--md box--shadow1 dropdown-menu-right border-0 p-0">
					...
					<div class="dropdown-menu__footer">
						<a class="view-all-message" href="">@lang('View all notification')</a>
					</div>
				</div>
			</li>
